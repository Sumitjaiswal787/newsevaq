  ...
  Future<Map<String, dynamic>?> getActiveBooking({
    ...
    try {
      ...
      if (activeBookings.isNotEmpty) {
        ...
        String eta = '14 mins'; // Fallback
        if (context != null) {
          try {
            final workerProvider = Provider.of<WorkerProvider>(context, listen: false);
            if (workerProvider.avgResponseTime > 0) {
              eta = '${workerProvider.avgResponseTime} mins';
            }
          } catch (_) {}
        }
      ...
      if (response != null) {
        return {
          ...
          'eta': response['eta'] ?? (context != null ? '${Provider.of<WorkerProvider>(context, listen: false).avgResponseTime} mins' : '14 mins'),
