      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            if (false) // Hidden as per user request
              TextButton(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 11,
                            fontWeight: FontWeight.w500,
                            color: AppTheme.emeraldGreen.withOpacity(0.55), // Lighter for secondary status
                          ),
                        ),
                      ],
                    ),
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            color: AppTheme.emeraldGreen.withOpacity(
              opacity.clamp(0.85, 1.0),
            ),
            shape: BoxShape.circle,
            boxShadow: [
              BoxShadow(
                color: AppTheme.emeraldGreen.withOpacity(0.108), // Reduced 10% opacity
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  height: 3,
                  decoration: BoxDecoration(
                    color: AppTheme.emeraldGreen.withOpacity(0.5), // Reduced from 0.7
                    shape: BoxShape.circle,
                  ),
                ),
              ),
              ...
              Positioned(
                ...
                child: Transform.scale(
                  ...
                  child: Container(
                    ...
                    height: 4,
                    decoration: BoxDecoration(
                      color: AppTheme.emeraldGreen.withOpacity(0.8), // Reduced from 1.0
                      shape: BoxShape.circle,
                      boxShadow: [
                        BoxShadow(
                          color: AppTheme.emeraldGreen.withOpacity(0.15), // Reduced from 0.2
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  height: 3,
                  decoration: BoxDecoration(
                    color: AppTheme.emeraldGreen.withOpacity(0.3), // Reduced from 0.5
                    shape: BoxShape.circle,
                  ),
                ),
              ),
