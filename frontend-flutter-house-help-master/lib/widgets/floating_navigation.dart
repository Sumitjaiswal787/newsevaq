          ...
          BackdropFilter(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: Colors.white.withOpacity(0.55), // Reduced translucency
                borderRadius: BorderRadius.circular(24),
                boxShadow: [
                  BoxShadow(
  ...
  Widget _buildNavItem(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected
              ? AppTheme.emeraldGreen.withOpacity(0.02) // Reduced 10% for softer blend into nav
              : Colors.transparent,
            ...
            Text(
              ...
              style: TextStyle(
                ...
                color: isSelected
                    ...
                    : Theme.of(context).colorScheme.onSurfaceVariant.withOpacity(0.7), // Increased 10% for better visibility
