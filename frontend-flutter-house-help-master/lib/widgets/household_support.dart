    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: const Color(0xFFE6E8E7).withOpacity(0.3),
            width: 0.5,
          ...
          children: [
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: const Color(0xFF606060).withOpacity(0.92), // Increased 6-8% for better readability
                    height:
            ...
            Positioned(
              ...
              child: Icon(
                ...
                size: 10,
                color: theme.colorScheme.onSurface.withOpacity(0.35), // Increased 10% for better visibility
              ),
            ),
          ],
        ),
