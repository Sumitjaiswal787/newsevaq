...
var AuditInterceptor = function () {
    ...
    var AuditInterceptor = _classThis = /** @class */ (function () {
        ...
        AuditInterceptor_1.prototype.intercept = function (context, next) {
            ...
            var now = Date.now();
            return next.handle().pipe((0, rxjs_1.tap)(function (response) { return __awaiter(_this, void 0, void 0, function () {
                var duration, action, urlParts, entityType, entityId, error_1, errorMessage;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            entityType = urlParts.length > 2 ? urlParts[2] : 'unknown';
                            entityId = urlParts.length > 3 ? urlParts[3] : undefined;
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.auditService.create({
                                    ...
                                    adminEmail: user === null || user === void 0 ? void 0 : user.email,
                                    action: action,
                        ...
                        case 3:
                            ...
                            this.logger.error("Audit logging failed: ".concat(errorMessage));
                            return [3 /*break*/, 4];
