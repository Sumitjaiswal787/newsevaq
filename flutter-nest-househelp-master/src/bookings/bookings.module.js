...
var subscription_sync_module_1 = require("../subscriptions/subscription-sync.module");
var BookingsModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                typeorm_1.TypeOrmModule.forFeature([booking_entity_1.Booking, worker_entity_1.Worker, service_entity_1.Service, user_entity_1.User, service_request_entity_1.ServiceRequest]),
