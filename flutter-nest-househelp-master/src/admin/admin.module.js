...
var AdminModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                typeorm_1.TypeOrmModule.forFeature([worker_entity_1.Worker, booking_entity_1.Booking, user_entity_1.User, subscription_entity_1.Subscription, service_entity_1.Service]),
            ],
