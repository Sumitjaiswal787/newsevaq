...
var AdminUser = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('admin_users')];
    ...
    var AdminUser = _classThis = /** @class */ (function () {
        ...
        AdminUser_1.prototype.generatePublicId = function () {
            if (!this.publicId) {
                this.publicId = (0, crypto_1.randomUUID)();
            }
        };
        Object.defineProperty(AdminUser_1.prototype, "fullName", {
            get: function () {
