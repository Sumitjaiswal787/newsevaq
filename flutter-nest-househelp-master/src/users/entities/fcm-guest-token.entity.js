...
exports.FcmGuestToken = void 0;
var typeorm_1 = require("typeorm");
var FcmGuestToken = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('fcm_guest_token')];
    ...
    var FcmGuestToken = _classThis = /** @class */ (function () {
        function FcmGuestToken_1() {
            this.deviceId = __runInitializers(this, _deviceId_initializers, void 0);
            this.token = (__runInitializers(this, _deviceId_extraInitializers), __runInitializers(this, _token_initializers, void 0));
        ...
        return FcmGuestToken_1;
    }());
    __setFunctionName(_classThis, "FcmGuestToken");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _deviceId_decorators = [(0, typeorm_1.PrimaryColumn)({ type: 'varchar', length: 256, name: 'device_id' })];
        _token_decorators = [(0, typeorm_1.Column)({ type: 'text', name: 'token' })];
        ...
        FcmGuestToken = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FcmGuestToken = _classThis;
}();
exports.FcmGuestToken = FcmGuestToken;
