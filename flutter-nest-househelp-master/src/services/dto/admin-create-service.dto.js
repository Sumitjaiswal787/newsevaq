...
exports.AdminCreateServiceDto = void 0;
var class_transformer_1 = require("class-transformer");
var class_validator_1 = require("class-validator");
var class_validator_2 = require("class-validator");
var AdminCreateServiceDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function AdminCreateServiceDto() {
            ...
            return AdminCreateServiceDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _name_decorators = [(0, class_transformer_1.Type)(function () { return String; }), (0, class_validator_1.IsString)({ message: 'Service name must be a string' }), (0, class_validator_1.IsNotEmpty)({ message: 'Service name is required' }), (0, class_validator_1.MinLength)(2, { message: 'Service name must be at least 2 characters long' }), (0, class_validator_1.MaxLength)(100, { message: 'Service name must not exceed 100 characters' })];
            _description_decorators = [(0, class_transformer_1.Type)(function () { return String; }), (0, class_validator_1.IsString)({ message: 'Description must be a string' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.MaxLength)(1000, { message: 'Description must not exceed 1000 characters' })];
            _category_decorators = [(0, class_transformer_1.Type)(function () { return String; }), (0, class_validator_1.IsString)({ message: 'Category must be a string' }), (0, class_validator_1.IsNotEmpty)({ message: 'Category is required for admin operations' }), (0, class_validator_1.MinLength)(2, { message: 'Category must be at least 2 characters long' }), (0, class_validator_1.MaxLength)(50, { message: 'Category must not exceed 50 characters' })];
            _subcategory_decorators = [(0, class_validator_1.IsOptional)(), (0, class_transformer_1.Type)(function () { return String; }), (0, class_validator_1.IsString)({ message: 'Subcategory must be a string' }), (0, class_validator_1.MinLength)(2, { message: 'Subcategory must be at least 2 characters long' }), (0, class_validator_1.MaxLength)(50, { message: 'Subcategory must not exceed 50 characters' })];
            _basePrice_decorators = [(0, class_transformer_1.Type)(function () { return Number; }), (0, class_validator_1.IsNumber)({}, { message: 'Base price must be a number' }), (0, class_validator_1.IsNotEmpty)({ message: 'Base price is required' }), (0, class_validator_1.Min)(0, { message: 'Base price must be greater than or equal to 0' })];
            _imageUrl_decorators = [(0, class_validator_1.IsOptional)(), (0, class_transformer_1.Type)(function () { return String; }), (0, class_validator_1.IsString)({ message: 'Image URL must be a string' }), (0, class_validator_1.MaxLength)(500, { message: 'Image URL must not exceed 500 characters' })];
            _isAvailable_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_2.IsBoolean)()];
            _isFastBooking_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_2.IsBoolean)()];
