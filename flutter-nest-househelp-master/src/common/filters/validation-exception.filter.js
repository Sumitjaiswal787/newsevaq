...
var ValidationExceptionFilter = function () {
    ...
    var ValidationExceptionFilter = _classThis = /** @class */ (function () {
        ...
        ValidationExceptionFilter_1.prototype.catch = function (exception, host) {
            ...
            this.logger.error("Validation failed for ".concat(request.method, " ").concat(request.url), {
                statusCode: status,
            ...
            response.status(status).json({
                ...
                errors: typeof exceptionResponse === 'string'
                    ? exceptionResponse
                    : (exceptionResponse === null || exceptionResponse === void 0 ? void 0 : exceptionResponse.message) || 'Invalid input data',
            });
        };
