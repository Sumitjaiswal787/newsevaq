...
var fcm_http_service_1 = require("./fcm-http.service");
...
var on_demand_notification_scheduler_1 = require("./on-demand-notification.scheduler");
...
var NotificationsModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                typeorm_1.TypeOrmModule.forFeature([booking_entity_1.Booking, subscription_entity_1.Subscription, user_entity_1.User, worker_entity_1.Worker]),
                schedule_1.ScheduleModule.forRoot(),
            ],
            controllers: [notifications_controller_1.NotificationsController],
            providers: [notifications_service_1.NotificationsService, fcm_http_service_1.FcmHttpService, notifications_scheduler_1.NotificationsScheduler, on_demand_notification_scheduler_1.OnDemandNotificationScheduler],
