...
class NotificationService {
  ...
  static const String upcomingJobChannelId = 'upcoming_job_reminder_channel';
  ...
  /// Trigger a simulated or local new booking event
  static void triggerNewBookingEvent(Map<String, dynamic> data) {
