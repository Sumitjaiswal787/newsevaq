...
class ApiService {
  ...
  Future<dynamic> applyForLeave(String workerId, String startDate, String endDate, String reason) async {
    return await post('worker-leaves', {
  ...
  Future<dynamic> getMyLeaves(String workerId) async {
    return await get('worker-leaves/$workerId');
  }
}
